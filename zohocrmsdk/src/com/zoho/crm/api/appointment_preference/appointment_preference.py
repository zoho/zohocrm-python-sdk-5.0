...
class AppointmentPreference(object):
	...
	def set_when_duration_exceeds(self, when_duration_exceeds):
		...
		Parameters:
			when_duration_exceeds (Choice) : An instance of Choice
		"""

		if when_duration_exceeds is not None and not isinstance(when_duration_exceeds, Choice):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: when_duration_exceeds EXPECTED TYPE: Choice', None, None)
	...
	def set_deal_record_configuration(self, deal_record_configuration):
		...
		Parameters:
			deal_record_configuration (dict) : An instance of dict
		"""

		if deal_record_configuration is not None and not isinstance(deal_record_configuration, dict):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: deal_record_configuration EXPECTED TYPE: dict', None, None)

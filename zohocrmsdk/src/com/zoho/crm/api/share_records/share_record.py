...
class ShareRecord(object):
	...
	def set_permission(self, permission):
		...
		Parameters:
			permission (Choice) : An instance of Choice
		"""

		if permission is not None and not isinstance(permission, Choice):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: permission EXPECTED TYPE: Choice', None, None)

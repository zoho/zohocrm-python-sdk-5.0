...
class PinFields(object):
	...
	def set_pin(self, pin):
		...
		Parameters:
			pin (Choice) : An instance of Choice
		"""

		if pin is not None and not isinstance(pin, Choice):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: pin EXPECTED TYPE: Choice', None, None)

...
class TagsOperations(object):
	...
	def get_tags(self, param_instance=None):
		...
		api_path = ''
		api_path = api_path + '/crm/v5/settings/tags'
	...
	def add_tags(self, record_id, module, request, param_instance=None):
		"""
	...
	def remove_tags(self, record_id, module, request):
		"""
	...
	def add_tags_to_multiple_records(self, module, request, param_instance=None):
		"""
	...
	def remove_tags_from_multiple_records(self, module, request, param_instance=None):
		"""

try:
	...
	from zohocrmsdk.src.com.zoho.crm.api.notifications.delete_details import DeleteDetails
except Exception:
	from ..exception import SDKException
	from ..util import Constants
	from .delete_details import DeleteDetails


class Event(DeleteDetails):
	def __init__(self):

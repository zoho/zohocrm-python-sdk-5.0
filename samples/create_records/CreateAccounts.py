...
class CreateAccounts(object):
    ...
    def create_accounts(module):
        ...
        parent_account.set_id(440248001393052)
        ...
        record1.add_field_value(Field.Accounts.ownership(), Choice("Private"))
...
CreateAccounts.create_accounts(module)
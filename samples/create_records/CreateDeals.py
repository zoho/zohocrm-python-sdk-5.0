...
class CreateDeals(object):
    ...
    @staticmethod
    def create_deals(module):
        record_operations = RecordOperations()
        body_wrapper = BodyWrapper()
        records = []
        record1 = Record()
        record1.add_field_value(Field.Deals.deal_name(), "deal_name")
        record1.add_field_value(Field.Deals.amount(), 100.0)
        record1.add_field_value(Field.Deals.closing_date(), datetime.date(2023, 12, 12))
        account = Record()
        account.set_id(440248001538033)
        record1.add_field_value(Field.Deals.account_name(), account)
        record1.add_field_value(Field.Deals.pipeline(), Choice("Standard (Standard)"))
        record1.add_field_value(Field.Deals.stage(), Choice("Qualification"))
        record1.add_field_value(Field.Deals.probability(), 10)
        record1.add_field_value(Field.Deals.type(), Choice("New Business"))
        record1.add_field_value(Field.Deals.next_step(), "next step")
        record1.add_field_value(Field.Deals.lead_source(), Choice("Advertisement"))
        contactName = Record()
        contactName.set_id(440248001541026)
        record1.add_field_value(Field.Deals.contact_name(), contactName)
        compaign = Record()
        compaign.set_id(440248001540035)
        record1.add_field_value(Field.Deals.campaign_source(), compaign)
        record1.add_field_value(Field.Deals.description(), "description")
...
CreateDeals.create_deals(module)
...
class LockARecord:
    ...
    @staticmethod
    def lock_a_record(module_api_name, record_id):
        ...
        response = record_locking_configurations_operations.lock_a_record(record_id, module_api_name, request)
...
LockARecord.initialize()
LockARecord.lock_a_record("Leads", 4402480377)

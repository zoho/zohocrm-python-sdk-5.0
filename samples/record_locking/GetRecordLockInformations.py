...
from zohocrmsdk.src.com.zoho.crm.api.record_locking import RecordLockingOperations, \
    ResponseWrapper, LockedForS, APIException, GetRecordLockingInformationsParam


class GetRecordLockInformations:
    @staticmethod
    def initialize():
    ...
    def get_record_lock_information(module_api_name, record_id):
        ...
        param_instance.add(GetRecordLockingInformationsParam.fields, "Lock_Source__s")
        response = record_locking_configurations_operations.get_record_locking_informations(param_instance)
...
GetRecordLockInformations.initialize()
GetRecordLockInformations.get_record_lock_information(module_api_name="Leads", record_id=440281787377)
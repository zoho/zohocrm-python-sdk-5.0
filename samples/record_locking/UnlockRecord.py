...
class UnlockRecord:
    ...
    @staticmethod
    def unlock_record(module_api_name, record_id, lock_id):
        record_locking_configurations_operations = RecordLockingOperations(record_id, module_api_name)
        response = record_locking_configurations_operations.unlock_record(lock_id)
...
UnlockRecord.initialize()
UnlockRecord.unlock_record(module_api_name="Leads", record_id=44024787377, lock_id=4402806006)

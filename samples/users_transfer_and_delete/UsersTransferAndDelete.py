...
class UsersTransferAndDelete(object):
    @staticmethod
    def initialize():
    ...
    def users_transfer_and_delete():
        ...
        response = user_transfer_delete_operations.users_transfer_and_delete(request)
...
UsersTransferAndDelete.initialize()
UsersTransferAndDelete.users_transfer_and_delete()
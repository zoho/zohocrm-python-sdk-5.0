...
class GetInventoryTemplateId:
    ...
    def get_inventory_template_by_id(id):
        ...
        response = inventory_templates_operations.get_inventory_template(id)
...
id = 4402480258288
GetInventoryTemplateId.initialize()
GetInventoryTemplateId.get_inventory_template_by_id(id)

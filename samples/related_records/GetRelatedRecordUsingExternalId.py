...
GetRelatedRecordUsingExternalId.get_related_record_using_external_id(module_api_name, external_value, related_list_api_name, external_field_value, destination_folder)
...
class UpdateAppointmentRescheduledHistory(object):
    @staticmethod
    def initialize():
    ...
    @staticmethod
    def update_appointment_reschedule_history(reschedule_id):
        ...
        response = reschedule_history_operations.update_appointment_rescheduled_history(reschedule_id, request)
...
reschedule_id = 3343452435340434
UpdateAppointmentRescheduledHistory.initialize()
UpdateAppointmentRescheduledHistory.update_appointment_reschedule_history(reschedule_id)
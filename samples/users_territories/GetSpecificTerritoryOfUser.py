...
class GetSpecificTerritoryOfUser(object):
    @staticmethod
    def initialize():
    ...
    @staticmethod
    def get_specific_territory_of_user(user_id, territory_id):
        user_territories_operartions = UsersTerritoriesOperations()
        response = user_territories_operartions.get_territory_of_user(territory_id, user_id)
...
GetSpecificTerritoryOfUser.get_specific_territory_of_user(user_id, territory_id)
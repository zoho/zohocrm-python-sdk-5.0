...
class ValidateBeforeTransferForAllTerritories(object):
    @staticmethod
    def initialize():
    ...
    @staticmethod
    def validate_before_transfer_for_all_territories(user_id):
        user_territories_operartions = UsersTerritoriesOperations()
        response = user_territories_operartions.validate_before_transfer_for_all_territories(user_id)
...
ValidateBeforeTransferForAllTerritories.validate_before_transfer_for_all_territories(user_id)
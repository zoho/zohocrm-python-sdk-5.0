...
class DelinkAndTransferFromSpecificTerritory(object):
    @staticmethod
    def initialize():
    ...
    @staticmethod
    def de_link_and_transfer_from_specific_territory(user_id, territory_id):
        ...
        transfer_to_user.set_id(4402480254001)
        ...
        response = user_territories_operations.delink_and_transfer_from_specific_territory(territory_id, user_id, request)
...
DelinkAndTransferFromSpecificTerritory.de_link_and_transfer_from_specific_territory(user_id, territory_id)
...
class UpdateTasks(object):
    ...
    @staticmethod
    def update_tasks(module):
        record_operations = RecordOperations()
        body_wrapper = BodyWrapper()
        records = []
        record1 = Record()
        record1.set_id(334234213123)
...
UpdateTasks.update_tasks(module)
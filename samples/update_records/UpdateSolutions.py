...
class UpdateSolutions(object):
    ...
    @staticmethod
    def update_solutions(module):
        record_operations = RecordOperations()
        body_wrapper = BodyWrapper()
        records = []
        record1 = Record()
        record1.set_id(321324321323)
        record1.add_field_value(Field.Solutions.solution_title(), "new Solution")
        record1.add_field_value(Field.Solutions.status(), Choice("Draft"))
        product = Record()
        product.set_id(345603456404533)
        record1.add_field_value(Field.Solutions.product_name(), product)
        record1.add_field_value(Field.Solutions.question(), "question?")
        record1.add_field_value(Field.Solutions.answer(), "answer")
...
UpdateSolutions.update_solutions(module)
...
class UpdateScoringRules(object):
    @staticmethod
    def initialize():
    ...
    def update_scoring_rules():
        ...
        scoring_rule.set_id("34440234230423")
        ...
        signal.set_namespace(Choice("Email_Incoming__s"))
        signal_rule.set_signal(signal)
        signal_rules.append(signal_rule)
        body_wrapper.set_scoring_rules(scoring_rules)
        response = scoring_rules_operations.update_scoring_rules(body_wrapper)
...
UpdateScoringRules.update_scoring_rules()
                ...
                for scoring_rule in scoring_rules:
                    ...
                    for fieldRule in fieldRules:
                        ...
                        if criteria is not None:
                            GetScoringRule.print_criteria(criteria)
    ...
    def print_criteria(criteria):
        ...
        if criteriaGroup is not None:
            for criteria1 in criteriaGroup:
                GetScoringRule.print_criteria(criteria1)
...
module = "Leads"
id = 440248001394064
GetScoringRule.initialize()
GetScoringRule.get_scoring_rule(module, id)
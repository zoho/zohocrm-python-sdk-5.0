...
from zohocrmsdk.src.com.zoho.crm.api.wizards import WizardsOperations, GetWizardbyIDParam, APIException, ResponseWrapper
                                        ...
                                        if buttons is not None:
                                            for button in buttons:
                                                ...
                                                if criteria is not None:
                                                    GetWizard.print_criteria(criteria)

...
from zohocrmsdk.src.com.zoho.crm.api.record import RecordOperations, SearchRecordsParam, ResponseWrapper, FileDetails, \
    Reminder, Participants, ImageUpload, PricingDetails, LineTax, Record, Comment, RecurringActivity, RemindAt, Consent, \
    APIException
...
class SearchRecords:
    ...
    def search_records(module_api_name):
        ...
        param_instance.add(SearchRecordsParam.cvid, "4402480029342")
...
SearchRecords.search_records(module_api_name)

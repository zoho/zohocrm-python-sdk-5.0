...
from zohocrmsdk.src.com.zoho.crm.api.variables import VariablesOperations, DeleteVariablesParam, ActionWrapper, \
...
class DeleteVariables:
    ...
    def delete_variables(variable_ids):
        ...
        """
        example
        variable_ids = [3409643002275025, 3409643002275035]
        """
...
DeleteVariables.delete_variables([33434234343, 3242342354])

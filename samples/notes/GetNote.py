...
from zohocrmsdk.src.com.zoho.crm.api.notes import NotesOperations, GetNoteParam, GetNoteHeader, ResponseWrapper, \
    APIException
...
class GetNote:
    ...
    def get_note(note_id):
        ...
        header_instance.add(GetNoteHeader.if_modified_since, str(datetime(2020, 6, 6, 10, 11, 12)))
                    ...
                    for note in notes_list:
                        ...
                        if attachments is not None:
                            for attachment in attachments:
                                GetNote.print_attachment(attachment)

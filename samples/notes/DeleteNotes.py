...
from zohocrmsdk.src.com.zoho.crm.api.notes import NotesOperations, DeleteNotesParam, ActionWrapper, SuccessResponse, \
    APIException
...
ids = [323242342, 339972930238]
DeleteNotes.initialize()
DeleteNotes.delete_notes(ids)

                ...
                if isinstance(response_object, ResponseWrapper):
                    ...
                    for attachment in attachments_list:
                        ...
                        if owner is not None:
                            ...
                            print("Attachment Owner - ID: " +
                                  str(owner.get_id()))
                            print("Attachment Owner - Email: " +
                                  owner.get_email())
                        print("Attachment Modified Time: " +
                              str(attachment.get_modified_time()))
                        print("Attachment File Name: " +
                              str(attachment.get_file_name()))
                        print("Attachment Created Time: " +
                              str(attachment.get_created_time()))
                        print("Attachment File Size: " +
                              str(attachment.get_size()))
                        parent_id = attachment.get_parent_id()
                        if parent_id is not None:
                            print("Attachment parent record Name: " +
                                  parent_id.get_key_value("name"))
                            print("Attachment parent record ID: " +
                                  str(parent_id.get_id()))
                        print("Attachment is Editable: " +
                              str(attachment.get_editable()))
                        print("Attachment File ID: " +
                              str(attachment.get_file_id()))
                        print("Attachment File Type: " +
                              str(attachment.get_type()))
                        print("Attachment Type: " +
                              str(attachment.get_attachment_type()))
                        print("Attachment SharingPermission: " +
                              str(attachment.get_sharing_permission()))
                        print("Attachment seModule: " +
                              str(attachment.get_se_module()))
                        modified_by = attachment.get_modified_by()
                        if modified_by is not None:
                            print("Attachment Modified By - Name: " +
                                  modified_by.get_name())
                            print("Attachment Modified By - ID: " +
                                  str(modified_by.get_id()))
                            print("Attachment Modified By - Email: " +
                                  modified_by.get_email())
                        print("Attachment State: " + str(attachment.get_state()))
                        created_by = attachment.get_created_by()
                        if created_by is not None:
                            print("Attachment Created By - Name: " +
                                  created_by.get_name())
                            print("Attachment Created By - ID: " +
                                  str(created_by.get_id()))
                            print("Attachment Created By - Email: " +
                                  created_by.get_email())
                        print("Attachment LinkUrl: " +
                              str(attachment.get_link_url()))
                    info = response_object.get_info()
                    if info is not None:
                        if info.get_per_page() is not None:
                            print('Attachment Info PerPage: ' +
                                  str(info.get_per_page()))
                        if info.get_page() is not None:
                            print('Attachment Info Page: ' +
                                  str(info.get_page()))
                        if info.get_count() is not None:
                            print('Attachment Info Count: ' +
                                  str(info.get_count()))
                        if info.get_more_records() is not None:
                            print('Attachment Info MoreRecords: ' +
...
GetAttachments.get_attachments(module, record_id)
...
class UploadLinkAttachment(object):
    ...
    def upload_link_attachment(module_api_name, record_id, attachment_url):
        ...
        param_instance.add(
            UploadUrlAttachmentsParam.attachmenturl, attachment_url)

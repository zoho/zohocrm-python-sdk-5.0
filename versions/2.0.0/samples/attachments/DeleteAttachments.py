...
class DeleteAttachments(object):
    ...
    def delete_attachments(module_api_name, record_id, attachment_ids):
        ...
        attachment_ids = [3409643002267012, 3409643002267018, 3409643002267010]
        """
...
attachment_ids = [440248001437004]
DeleteAttachments.initialize()
DeleteAttachments.delete_attachments(module, record_id, attachment_ids)

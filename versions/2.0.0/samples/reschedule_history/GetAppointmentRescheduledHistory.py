...
class GetAppointmentRescheduledHistory(object):
    @staticmethod
    def initialize():
    ...
    @staticmethod
    def get_appointment_rescheduled_history(id):
        rescheduled_history_operations = RescheduleHistoryOperations()
        param_instance = ParameterMap()
        response = rescheduled_history_operations.get_appointment_rescheduled_history(id, param_instance)
...
id = 440248001497003
GetAppointmentRescheduledHistory.initialize()
GetAppointmentRescheduledHistory.get_appointment_rescheduled_history(id)
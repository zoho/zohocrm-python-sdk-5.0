...
class SendMail(object):
    ...
    def send_mail(record_id, module_api_name):
        ...
        attachment.set_id("dd81864b4812b1f8b0b4fe0949a982de89fa75a")
        ...
        user_address_cc.set_email("abc@zoho.com")
        user_address_bcc.set_user_name("Jassdon Smith")
        user_address_bcc.set_email("abcd@zoho.com")
        user_address_reply_to.set_user_name("Jassdon Smith")
        user_address_reply_to.set_email("abc2@zoho.com")

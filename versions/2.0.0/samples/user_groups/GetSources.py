            ...
            if isinstance(response_object, SourcesWrapper):
                ...
                for source in sources:
                    ...
                    if source1 is not None:
                        print("Sources user_name: " + source1.get_name())
                        print("sources user_id: " + str(source1.get_id()))
                    print("sources Type : " + source.get_type().get_value())
                    print("Source Subordiunates: " + str(source.get_subordinates()))
...
GetSources.get_sources(group_id=440248001219057)
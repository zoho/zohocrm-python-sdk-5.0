...
class UpdateShiftHours(object):
    ...
    def update_shift_hours():
        ...
        shift_hours.set_id(3342343423543)
        shift_hours.set_timezone("Asia/Kolkata")
        ...
        custom_timing1.set_days("Monday")
        ...
        custom_timings_for_break_hour1.set_days("Monday")
        ...
        response = shift_hours_operations.update_shift_hours(request)
...
UpdateShiftHours.update_shift_hours()
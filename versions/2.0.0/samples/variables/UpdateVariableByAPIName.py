...
from zohocrmsdk.src.com.zoho.crm.api.variables import VariablesOperations, BodyWrapper, Variable, ActionWrapper, \
    SuccessResponse, APIException, GetVariableByAPINameParam
...
class UpdateVariableByAPIName:
    ...
    def update_variable_by_api_name(variable_api_name):
        ...
        param_instance.add(GetVariableByAPINameParam.group, "")
        response = variables_operations.update_variable_by_apiname(variable_api_name, request, param_instance)

...
from zohocrmsdk.src.com.zoho.crm.api.variables import VariablesOperations, ActionWrapper, SuccessResponse, APIException
...
DeleteVariable.delete_variable(440248001508)

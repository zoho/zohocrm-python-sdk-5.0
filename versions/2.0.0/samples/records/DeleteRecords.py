...
from zohocrmsdk.src.com.zoho.crm.api.record import RecordOperations, DeleteRecordsParam, ActionWrapper, SuccessResponse, \
    APIException
...
record_ids = [3234234234234, 342343434223]
DeleteRecords.initialize()
DeleteRecords.delete_records(module_api_name, record_ids)
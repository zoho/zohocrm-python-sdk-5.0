...
from zohocrmsdk.src.com.zoho.crm.api.record import RecordOperations, BodyWrapper, Record, Field, PricingDetails, \
    ImageUpload, FileDetails, Consent, LineItemProduct, LineTax, RemindAt, RecurringActivity, Participants, \
...
class CreateRecords:
    ...
    def create_records(module_api_name):
        ...
        fileDetail.set_file_id__s("ae9c7cefa41887c6d90b0bd44183")
        fileDetails.append(fileDetail)
        fileDetail2 = FileDetails()
        fileDetail2.set_file_id__s("ae9c7cefa418aec1dd87c6d90b0bd44183")

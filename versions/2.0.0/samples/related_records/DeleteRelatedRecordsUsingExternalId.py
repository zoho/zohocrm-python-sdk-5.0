...
from zohocrmsdk.src.com.zoho.crm.api.email_related_records import APIException
from zohocrmsdk.src.com.zoho.crm.api.related_records import RelatedRecordsOperations, DelinkRecordsParam, ActionWrapper, \
    SuccessResponse
...
DeleteRelatedRecordsUsingExternalId.delete_related_records_using_external_id(module_api_name, external_value, related_list_api_name, external_field_value)

...
from zohocrmsdk.src.com.zoho.crm.api.record import FileDetails, Reminder, Participants, PricingDetails, Record, LineTax, \
    Comment, ImageUpload, RemindAt, RecurringActivity, Consent
...
class GetRelatedRecord:
    ...
    def get_related_record(module_api_name, record_id, related_list_api_name, related_list_id, destination_folder):
        ...
        response = related_records_operations.get_related_record(related_list_id, record_id, param_instance, header_instance)
                                ...
                                if len(value) > 0:
                                    if isinstance(value[0], FileDetails):
                                        ...
                                        for file_detail in file_details:
                                            ...
                                            print(
                                                "RelatedRecord FileDetails DownloadUrl: " + file_detail.get_download_url())
                                            print(
                                            ...
                                            print(
                                                "RelatedRecord FileDetails OriginalSizeByte: " + file_detail.get_original_size_byte())
                                            print(
                                                "RelatedRecord FileDetails PreviewUrl: " + file_detail.get_preview_url())
                                            ...
                                            print(
                                                "RelatedRecord FileDetails AttachmentId: " + file_detail.get_attachment_id())
                                        ...
                                        for participant in participants:
                                            ...
                                            print(
                                                "RelatedRecord Participants Participant: " + participant.get_participant())
...
related_list_id = 440248001495003
destination_folder = "/Users/sample/file"
GetRelatedRecord.initialize()
GetRelatedRecord.get_related_record(module_api_name, record_id, related_list_api_name, related_list_id, destination_folder)

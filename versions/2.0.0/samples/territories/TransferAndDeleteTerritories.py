...
from zohocrmsdk.src.com.zoho.crm.api.territories import TerritoriesOperations, TransferBodyWrapper, TransferTerritory, \
    ActionWrapper, SuccessResponse, APIException


class TransferAndDeleteTerritories(object):
    @staticmethod
    def initialize():
    ...
    def transfer_and_delete_territories():
        ...
        territories = []
        territory = TransferTerritory()
        territory.set_id(334253435435)
        territory.set_transfer_to_id(3323423423)
        territory.set_delete_previous_forecasts(False)

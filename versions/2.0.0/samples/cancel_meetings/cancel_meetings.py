...
from zohocrmsdk.src.com.zoho.crm.api.cancel_meetings import CancelMeetingsOperations, BodyWrapper, Notify, \
...
event_id = 440248001438030
send_cancel_mail = False
CancelMeetings.initialize()
CancelMeetings.cancel_meetings(event_id, send_cancel_mail)

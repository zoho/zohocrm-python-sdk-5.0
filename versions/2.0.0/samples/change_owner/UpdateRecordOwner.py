...
from zohocrmsdk.src.com.zoho.crm.api.change_owner import ChangeOwnerOperations, BodyWrapper, Owner, RelatedModules, \
    ActionWrapper, SuccessResponse, APIException
from zohocrmsdk.src.com.zoho.crm.api.dc import USDataCenter


class UpdateRecordOwner(object):
    @staticmethod
    def initialize():
    ...
    @staticmethod
    def update_record_owner(module_api_name, record_id):
...
module = "Leads"
record_id = 440248001410023
UpdateRecordOwner.initialize()
UpdateRecordOwner.update_record_owner(module, record_id)
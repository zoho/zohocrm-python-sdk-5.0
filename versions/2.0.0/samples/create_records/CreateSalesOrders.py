...
class CreateSalesOrders(object):
    @staticmethod
    def initialize():
    ...
    @staticmethod
    def create_sales_orders(module):
        ...
        quoteName = Record()
        quoteName.set_id(440248001537032)
        ...
        deal_name = Record()
        deal_name.set_id(440248001538050)
        record1.add_field_value(Field.Sales_Orders.deal_name(), deal_name)
        contact_name = Record()
        contact_name.set_id(440248001541026)
...
CreateSalesOrders.create_sales_orders(module)
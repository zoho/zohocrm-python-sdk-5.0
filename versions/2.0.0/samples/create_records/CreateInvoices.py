...
class CreateInvoices(object):
    ...
    def create_invoices(module):
        ...
        accountname.add_field_value(Field.Invoices.account_name(), accountname)
...
CreateInvoices.create_invoices(module)
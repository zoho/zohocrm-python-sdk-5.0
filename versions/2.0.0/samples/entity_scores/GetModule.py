...
class GetModule(object):
    ...
    @staticmethod
    def get_module(record_id, module):
        enitity_scores_operations = EntityScoresOperations("Positive_Score")
        response = enitity_scores_operations.get_module(record_id, module)
...
record_id = 440248001409012
module = "Leads"
GetModule.initialize()
GetModule.get_module(record_id, module)
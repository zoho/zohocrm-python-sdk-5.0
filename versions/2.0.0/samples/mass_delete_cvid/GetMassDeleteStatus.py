        ...
        if response is not None:
            ...
            if isinstance(response_object, ResponseWrapper):
                ...
                for status1 in status:
                    print("MassDelete TotalCount: " + str(status1.get_total_count()))
                    print("MassDelete ConvertedCount: " + str(status1.get_deleted_count()))
                    print("MassDelete FailedCount: " + str(status1.get_failed_count()))
                    print("MassDelete Status: " + str(status1.get_status()))

...
class UpdateVendors(object):
    ...
    def update_vendors(module):
        ...
        record1.add_field_value(Field.Vendors.city(), "city")
        record1.add_field_value(Field.Vendors.country(), "country")
        record1.add_field_value(Field.Vendors.state(), "state")
        record1.add_field_value(Field.Vendors.street(), "street")
        record1.add_field_value(Field.Vendors.zip_code(), "zipcode")
        record1.add_field_value(Field.Vendors.description(), "description")
...
UpdateVendors.update_vendors(module)
...
class UpdateCalls(object):
    ...
    @staticmethod
    def update_calls(module):
        record_operations = RecordOperations()
        body_wrapper = BodyWrapper()
        records = []
        record1 = Record()
        record1.set_id(34234234223)

        # schedule a call
        who_id = Record()
        who_id.set_id(3232093213223290)
        record1.add_field_value(Field.Calls.who_id(), who_id)
        what_id = Record()
        what_id.set_id(44024800139206)
        ...
        # log a call
        who_id_1 = Record()
        who_id_1.set_id(33232323213123)
        record1.add_field_value(Field.Calls.who_id(), who_id_1)
        what_id_1 = Record()
        what_id_1.set_id(3232412321123)
        ...
        record1.add_field_value(Field.Calls.call_start_time(), datetime.datetime(2023, 11, 20, 10, 0, 1))
        record1.add_field_value(Field.Calls.call_purpose(), Choice("Demo"))
        record1.add_field_value(Field.Calls.call_agenda(), "agenda to make call")
...
UpdateCalls.update_calls(module)
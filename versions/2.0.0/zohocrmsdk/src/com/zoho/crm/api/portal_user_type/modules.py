...
class Modules(object):
	...
	def set_shared_type(self, shared_type):
		...
		Parameters:
			shared_type (Choice) : An instance of Choice
		"""

		if shared_type is not None and not isinstance(shared_type, Choice):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: shared_type EXPECTED TYPE: Choice', None, None)

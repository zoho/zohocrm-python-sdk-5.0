...
class EntityScores(object):
	...
	def get_entity(self):
		...
		Returns:
			EntityStructureGroup: An instance of EntityStructureGroup
		"""
	...
	def set_entity(self, entity):
		...
		Parameters:
			entity (EntityStructureGroup) : An instance of EntityStructureGroup
		"""
		...
		if entity is not None and not isinstance(entity, EntityStructureGroup):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: entity EXPECTED TYPE: EntityStructureGroup', None, None)
	...
	def get_scoring_rule(self):
		...
		Returns:
			ScoringRuleStructure: An instance of ScoringRuleStructure
		"""
	...
	def set_scoring_rule(self, scoring_rule):
		...
		Parameters:
			scoring_rule (ScoringRuleStructure) : An instance of ScoringRuleStructure
		"""

		try:
			from zohocrmsdk.src.com.zoho.crm.api.entity_scores.scoring_rule_structure import ScoringRuleStructure
		except Exception:
			from .scoring_rule_structure import ScoringRuleStructure

		if scoring_rule is not None and not isinstance(scoring_rule, ScoringRuleStructure):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: scoring_rule EXPECTED TYPE: ScoringRuleStructure', None, None)

...
class ModuleFields(Fields):
	...
	def get_lookup(self):
		...
		Returns:
			ModuleFieldLookup: An instance of ModuleFieldLookup
		"""
	...
	def set_lookup(self, lookup):
		...
		Parameters:
			lookup (ModuleFieldLookup) : An instance of ModuleFieldLookup
		"""

		try:
			from zohocrmsdk.src.com.zoho.crm.api.modules.module_field_lookup import ModuleFieldLookup
		except Exception:
			from .module_field_lookup import ModuleFieldLookup

		if lookup is not None and not isinstance(lookup, ModuleFieldLookup):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: lookup EXPECTED TYPE: ModuleFieldLookup', None, None)

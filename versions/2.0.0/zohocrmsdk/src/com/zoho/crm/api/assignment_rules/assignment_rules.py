...
class AssignmentRules(object):
	...
	def get_default_assignee(self):
		...
		Returns:
			DefaultAssignee: An instance of DefaultAssignee
		"""

		return self.__default_assignee

	def set_default_assignee(self, default_assignee):
		"""
		The method to set the value to default_assignee

		Parameters:
			default_assignee (DefaultAssignee) : An instance of DefaultAssignee
		"""

		try:
			from zohocrmsdk.src.com.zoho.crm.api.assignment_rules.default_assignee import DefaultAssignee
		except Exception:
			from .default_assignee import DefaultAssignee

		if default_assignee is not None and not isinstance(default_assignee, DefaultAssignee):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: default_assignee EXPECTED TYPE: DefaultAssignee', None, None)
		
		self.__default_assignee = default_assignee
		self.__key_modified['default_assignee'] = 1
	...
	def get_modified_by(self):
		...
		Returns:
			CreatedBy: An instance of CreatedBy
		"""
	...
	def set_modified_by(self, modified_by):
		...
		Parameters:
			modified_by (CreatedBy) : An instance of CreatedBy
		"""

		try:
			from zohocrmsdk.src.com.zoho.crm.api.assignment_rules.created_by import CreatedBy
		except Exception:
			from .created_by import CreatedBy

		if modified_by is not None and not isinstance(modified_by, CreatedBy):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: modified_by EXPECTED TYPE: CreatedBy', None, None)
	...
	def set_created_by(self, created_by):
		...
		Parameters:
			created_by (CreatedBy) : An instance of CreatedBy
		"""
		...
		if created_by is not None and not isinstance(created_by, CreatedBy):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: created_by EXPECTED TYPE: CreatedBy', None, None)

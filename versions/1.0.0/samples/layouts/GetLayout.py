...
from zohocrmsdk.src.com.zoho.crm.api.layouts import LayoutsOperations, ResponseWrapper, APIException, GetLayoutParam
...
class GetLayout:
    ...
    def get_layout(module_api_name, layout_id):
        ...
        param_instance.add(GetLayoutParam.module, module_api_name)
    ...
    def print_field(field):
        ...
        if multi_module_lookup is not None:
            print("Lookup apiname: " + str(multi_module_lookup.get_api_name()))
        ...
        if pick_list_values is not None:
            for pick_list_value in pick_list_values:
                GetLayout.print_pick_list_value(pick_list_value)
        ...
        if pick_list_values is not None:
            for plv in pick_list_values:
                GetLayout.print_pick_list_value(plv)
...
GetLayout.get_layout(module, layout_id)

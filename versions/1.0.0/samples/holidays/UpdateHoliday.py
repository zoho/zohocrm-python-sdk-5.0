...
class UpdateHoliday(object):
    ...
    def update_holiday(holiday_id):
        ...
        response = holidays_operations.update_holiday(holiday_id, request)
...
UpdateHoliday.initialize()
UpdateHoliday.update_holiday(holiday_id)
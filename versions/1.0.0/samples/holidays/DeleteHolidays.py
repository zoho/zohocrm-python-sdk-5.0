...
class DeleteHolidays(object):
    ...
    @staticmethod
    def delete_holidays(holiday_id):
        holidays_operations = HolidaysOperations()
        response = holidays_operations.delete_holiday(holiday_id)
...
DeleteHolidays.delete_holidays(holiday_id)
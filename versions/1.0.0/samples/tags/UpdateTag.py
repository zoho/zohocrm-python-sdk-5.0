...
from zohocrmsdk.src.com.zoho.crm.api.tags import TagsOperations, UpdateTagParam, BodyWrapper, Tag, ActionWrapper, \
...
UpdateTag.update_tag(module_api_name="Leads", tag_id=33423423423423)
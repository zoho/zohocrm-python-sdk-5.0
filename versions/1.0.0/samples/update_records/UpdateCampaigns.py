...
class UpdateCampaigns(object):
    ...
    @staticmethod
    def update_campaigns(module):
        record_operations = RecordOperations()
        body_wrapper = BodyWrapper()
        records = []
        record1 = Record()
        record1.set_id(3242423423412)
        record1.add_field_value(Field.Campaigns.campaign_name(), "New Campaign")
        record1.add_field_value(Field.Campaigns.start_date(), datetime.date(2023, 12, 12))
        record1.add_field_value(Field.Campaigns.end_date(), datetime.date(2023, 12, 20))
        record1.add_field_value(Field.Campaigns.num_sent(), 10)
        record1.add_field_value(Field.Campaigns.actual_cost(), 100.0)
        record1.add_field_value(Field.Campaigns.expected_revenue(), 200.0)
        record1.add_field_value(Field.Campaigns.type(), Choice("Webinar"))
        record1.add_field_value(Field.Campaigns.budgeted_cost(), 120.0)
        record1.add_field_value(Field.Campaigns.expected_response(), 200)
        record1.add_field_value(Field.Campaigns.description(), "Description of campaign")
        record1.add_field_value(Field.Campaigns.status(), Choice("Active"))
...
UpdateCampaigns.update_campaigns(module)
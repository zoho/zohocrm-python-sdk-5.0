...
class UpdateCases(object):
    ...
    @staticmethod
    def update_cases(module):
        record_operations = RecordOperations()
        body_wrapper = BodyWrapper()
        records = []
        record1 = Record()
        record1.set_id(342343423432)
        ...
        contactName = Record()
        contactName.add_key_value("id", 3121012312232)
        ...
        dealName = Record()
        dealName.add_key_value("id", 392223423412)
...
UpdateCases.update_cases(module)
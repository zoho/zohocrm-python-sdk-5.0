...
class UpdateInvoices(object):
    ...
    @staticmethod
    def update_invoices(module):
        record_operations = RecordOperations()
        body_wrapper = BodyWrapper()
        records = []
        record1 = Record()
        record1.set_id(323424121323)
        accountname = Record()
        accountname.add_key_value("name", "automated")
        accountname.add_field_value(Field.Accounts.id, 440248884001)
        record1.add_field_value(Field.Invoices.account_name(), accountname)
        record1.add_field_value(Field.Invoices.subject(), "new invoice")
        record1.add_field_value(Field.Invoices.adjustment(), 10.0)
        record1.add_field_value(Field.Invoices.invoice_date(), datetime.date(2023, 10, 12))
        record1.add_field_value(Field.Invoices.due_date(), datetime.date(2023, 12, 12))
        record1.add_field_value(Field.Invoices.sales_commission(), 20.0)
        record1.add_field_value(Field.Invoices.purchase_order(), "purchase order")
        record1.add_field_value(Field.Invoices.excise_duty(), 10.0)
        record1.add_field_value(Field.Invoices.status(), Choice("Created"))
        contactname = Record()
        contactname.add_field_value(Field.Contacts.id, 347706111853001)
        record1.add_field_value(Field.Invoices.contact_name(), contactname)
        dealname = Record()
        dealname.add_field_value(Field.Deals.id, 347706111383007)
        record1.add_key_value("Deal_Name__s", dealname)
        sales_order = Record()
        sales_order.add_field_value(Field.Sales_Orders.id, 32203232899292)
        record1.add_field_value(Field.Invoices.sales_order(), sales_order)
        record1.add_field_value(Field.Invoices.terms_and_conditions(), "details of terms and conditions")
        record1.add_field_value(Field.Invoices.description(), "description")
        ...
        inventoryLineItemList.append(inventoryLineItem)
        record1.add_field_value(Field.Invoices.invoiced_items(), inventoryLineItemList)
        lineTaxes =[]
        lineTax = LineTax()
        ...
        # Address info
        record1.add_field_value(Field.Invoices.billing_city(), "city")
        record1.add_field_value(Field.Invoices.billing_code(), "12345")
        record1.add_field_value(Field.Invoices.billing_country(), "country")
        record1.add_field_value(Field.Invoices.billing_state(), "state")
        record1.add_field_value(Field.Invoices.billing_street(), "street")
        record1.add_field_value(Field.Invoices.shipping_city(), "shipping city")
        record1.add_field_value(Field.Invoices.shipping_code(), "shipping code")
        record1.add_field_value(Field.Invoices.shipping_country(), "shipping country")
        record1.add_field_value(Field.Invoices.shipping_state(), "shipping state")
        record1.add_field_value(Field.Invoices.shipping_street(), "shipping street")
...
UpdateInvoices.update_invoices(module)
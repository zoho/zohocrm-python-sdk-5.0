...
class UpdateDeals(object):
    ...
    def update_deals(module):
        ...
        contactName = Record()
        contactName.set_id(40223200342313)
        record1.add_field_value(Field.Deals.contact_name(), contactName)
        compaign = Record()
        compaign.set_id(322311243223)
...
UpdateDeals.update_deals(module)
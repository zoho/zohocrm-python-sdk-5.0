...
class UpdateLockReasonOfRecord:
    @staticmethod
    def initialize():
    ...
    @staticmethod
    def update_lock_reason_of_record(module_api_name, record_id, lock_id):
        ...
        response = record_locking_configurations_operations.update_lock_reason_of_a_record(lock_id, record_id, module_api_name, request)
...
UpdateLockReasonOfRecord.initialize()
UpdateLockReasonOfRecord.update_lock_reason_of_record(module_api_name="Leads", record_id=44020787377, lock_id=440241806006)

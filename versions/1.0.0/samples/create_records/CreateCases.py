...
class CreateCases(object):
    ...
    @staticmethod
    def create_cases(module):
        record_operations = RecordOperations()
        body_wrapper = BodyWrapper()
        records = []
        record1 = Record()
        record1.add_field_value(Field.Cases.subject(), "new Case")
        record1.add_field_value(Field.Cases.type(), Choice("Question"))
        product_name = Record()
        product_name.add_key_value("id", 440248001391082)
        record1.add_field_value(Field.Cases.product_name(), product_name)
        record1.add_field_value(Field.Cases.case_origin(), Choice("Email"))
        record1.add_field_value(Field.Cases.status(), Choice("On Hold"))
        record1.add_field_value(Field.Cases.reported_by(), "none")
        record1.add_field_value(Field.Cases.phone(), "31231242131")
        contactName = Record()
        contactName.add_key_value("id", 440248001509050)
        record1.add_field_value(Field.Cases.related_to(), contactName)
        accountName = Record()
        accountName.add_key_value("id", 440248001538033)
        ...
        dealName = Record()
        dealName.add_key_value("id", 440248001393069)
        record1.add_field_value(Field.Cases.deal_name(), dealName)
        record1.add_field_value(Field.Cases.description(), "description of case")
        record1.add_field_value(Field.Cases.internal_comments(), "comments")
        record1.add_field_value(Field.Cases.solution(), "Solution for problem")
...
CreateCases.create_cases(module)
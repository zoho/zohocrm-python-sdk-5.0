...
class RecordOperations(object):
	...
	def convert_lead(self, id, request):
		...
		try:
			from zohocrmsdk.src.com.zoho.crm.api.record.convert_body_wrapper import ConvertBodyWrapper
		except Exception:
		...
		handler_instance = CommonAPIHandler()
		api_path = ''
		api_path = api_path + '/crm/v5/Leads/'
		api_path = api_path + str(id)
	...
	def upload_photo(self, id, module_api_name, request, param_instance=None):
		"""
	...
	def lead_conversion_options(self, id, module_api_name):
		"""

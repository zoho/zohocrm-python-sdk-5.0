...
class Currency(object):
	...
	def get_format(self):
		...
		Returns:
			CurrencyFormat: An instance of CurrencyFormat
		"""
	...
	def set_format(self, format):
		...
		Parameters:
			format (CurrencyFormat) : An instance of CurrencyFormat
		"""

		try:
			from zohocrmsdk.src.com.zoho.crm.api.currencies.currency_format import CurrencyFormat
		except Exception:
			from .currency_format import CurrencyFormat

		if format is not None and not isinstance(format, CurrencyFormat):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: format EXPECTED TYPE: CurrencyFormat', None, None)

...
class PermissionDetail(object):
	...
	def set_enabled(self, enabled):
		...
		Parameters:
			enabled (Choice) : An instance of Choice
		"""

		if enabled is not None and not isinstance(enabled, Choice):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: enabled EXPECTED TYPE: Choice', None, None)

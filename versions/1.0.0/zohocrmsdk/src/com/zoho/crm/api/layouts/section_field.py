...
class SectionField(Fields):
	...
	def set_length(self, length):
		...
		Parameters:
			length (Choice) : An instance of Choice
		"""

		if length is not None and not isinstance(length, Choice):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: length EXPECTED TYPE: Choice', None, None)
	...
	def get_subform(self):
		...
		Returns:
			SectionSubformField: An instance of SectionSubformField
		"""
	...
	def set_subform(self, subform):
		...
		Parameters:
			subform (SectionSubformField) : An instance of SectionSubformField
		"""

		try:
			from zohocrmsdk.src.com.zoho.crm.api.layouts.section_subform_field import SectionSubformField
		except Exception:
			from .section_subform_field import SectionSubformField

		if subform is not None and not isinstance(subform, SectionSubformField):
			raise SDKException(Constants.DATA_TYPE_ERROR, 'KEY: subform EXPECTED TYPE: SectionSubformField', None, None)
